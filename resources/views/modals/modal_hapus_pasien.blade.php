<form class="needs-validation" action="/hapus-data-pasien/{{ $pasien->nik }}" method="GET" novalidate>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                                ...
                                <table class="table table-sm table-borderless">
                                    ...
                                    <tbody id="modal-body-hapus">
                                        ...
                                        <tr style="font-size: 15px">
                                            ...
                                            <td style="min-width: 20px;"> : </td>
                                            <td style="width: 100%; word-break: break-all;">{{ 'rt '.$alamatPasien->rt.", rw ".$alamatPasien->rw.", ".$alamatPasien->kelurahan_desa. ", ".$alamatPasien->kecamatan.", ".$alamatPasien->kabupaten_kota.", ".$alamatPasien->provinsi }}</td>
                                        </tr>                                        
                ...
                <div class="modal-footer">
                    ...
                    <button style="submit" class="btn btn-danger">Hapus</button>
                </div>
